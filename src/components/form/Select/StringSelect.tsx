...
import type { StringOption } from "@/types/core";
import type { StringSelectType } from "./types";
import { clsx } from "clsx";

type SelectRHFProps = {
  value: StringOption | undefined;
    ...
    <Field className="w-full">
      ...
      <Listbox
        ...
        <ListboxButton
          ...
          data-invalid={error}
          className={clsx(
            "bg-surface text-foreground ring-input-border focus:ring-focus-ring relative w-full cursor-pointer rounded-md py-1.5 pr-10 pl-3 text-left shadow-xs ring-1 ring-inset focus:ring-2 focus:outline-hidden data-disabled:cursor-not-allowed data-disabled:opacity-60 sm:text-sm sm:leading-6",
