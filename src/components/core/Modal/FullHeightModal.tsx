      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div
          ...
          <DialogPanel
            transition
            className={clsx(
              "bg-elevated relative w-full max-w-md transform overflow-hidden rounded-lg px-4 pt-5 pb-4 text-left shadow-xl transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in sm:my-8 sm:max-w-lg sm:p-6 sm:data-closed:translate-y-0 sm:data-closed:scale-95",
              className,
            )}>
            {children}
          </DialogPanel>
