  ...
  return (
    <article className="flex h-full min-h-[720px] flex-col rounded-2xl border border-slate-200/60 bg-white/70 p-4 shadow-[0_18px_60px_-28px_rgba(15,23,42,0.4)]">
      ...
      <div className="flex flex-1 flex-col gap-3 overflow-hidden">
        ...
        {!isPending && !hasTasks && (
          <div className="flex flex-1 items-center justify-center rounded-xl border border-dashed border-slate-200/80 bg-white/40 text-xs font-semibold uppercase tracking-[0.3em] text-slate-300">
            No Tasks
          </div>
        )}
      </div>
