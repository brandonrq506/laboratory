...
describe("secondsToTime", () => {
  ...
  it("returns '59s' when seconds is 59", () => {
    const seconds = 59;
    expect(secondsToTime(seconds)).toBe("59s");
  });

  it("returns '1:01m' when seconds is 61", () => {
    const seconds = 61;
    expect(secondsToTime(seconds)).toBe("1:01m");
  });

  it("returns '30m' when seconds is 1800", () => {
    const seconds = 1800;
    expect(secondsToTime(seconds)).toBe("30m");
  });

  it("returns 1h when seconds is 3600", () => {
    const seconds = 3600;
    expect(secondsToTime(seconds)).toBe("1h");
  });

  it("returns '1:00:54h' when seconds is 3654", () => {
    const seconds = 3654;
    expect(secondsToTime(seconds)).toBe("1:00:54h");
  });

  it("returns '1:30h' when seconds is 5400", () => {
    const seconds = 5400;
    expect(secondsToTime(seconds)).toBe("1:30h");
  });

  it("returns '23:59:59h' when seconds is 86399", () => {
    const seconds = 86399;
    expect(secondsToTime(seconds)).toBe("23:59:59h");
  });

  it("returns '24h' when seconds is 86400", () => {
    const seconds = 86400;
    expect(secondsToTime(seconds)).toBe("24h");
  });
